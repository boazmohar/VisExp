...
expName = u'Text'  # from the Builder filename that created this script
...
# Setup the Window
win = visual.Window(
    size=[100, 100], fullscr=False, screen=0,
...
trials = data.TrialHandler(nReps=5, method='sequential', 
    ...
    trialList=data.importConditions(u'Grating_params.xlsx'),
