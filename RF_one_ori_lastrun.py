...
expName = u'RF_one_ori'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\labadmin\\Documents\\VisExp\\RF_one_ori.psyexp',
...
win = visual.Window(
    ...
    monitor=u'xrite', color=[-1,-1,0], colorSpace='rgb',
